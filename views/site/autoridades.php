...
<div class="container-lg">
    <div class="con-augtoridades mt-3">
        <h3 class="mt-4 mb-4 text-center"> <span class="overpassbold text-blue-site"> Comisión directiva: </span> Autoridades</h3>
        <ul class="image-gallery">
            <?php $directorioImagenes = \Yii::getAlias('@web') . DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'autoridades' . DIRECTORY_SEPARATOR; ?>
            <li>
                <img src="<?= $directorioImagenes . 'presidente.jpg'; ?>" alt="" />
                <div class="overlay-titulo"><span>Presidente</span></div>
                <div class="overlay-descripcion">
                    <span class="overpassbolditalic"> Presidente </span> 
                    <br /><span class=""> ZIEDE, Omar René </span>
                </div>
            </li> 
            <li>
                <img src="<?= $directorioImagenes . 'tesorero.jpg'; ?>" alt="" />
                <div class="overlay-titulo"><span>Tesorero</span></div>
                <div class="overlay-descripcion">
                    <span class="overpassbolditalic"> Tesorero </span> 
                    <br /><span class=""> HAM, Juan Guillermo </span>
                </div>
            </li>
            <li>
                <img src="<?= $directorioImagenes . 'secretaria.jpg'; ?>" alt="" />
                <div class="overlay-titulo"><span>Secretaria</span></div>
                <div class="overlay-descripcion">
                    <span class="overpassbolditalic"> Secretaria </span> 
    ...
    <div class="row m-auto">
        <div class="col-lg-12 mt-3 text-center">
            ...
            <h3 class="text-blue-site overpassbold  mt-5">MIEMBROS TITULARES</h3>
            <ul class="list-unstyled m-3">
                <li>MACSARD, Roberto Tufik</li>
                <li>ARMAS, Jorge Alberto</li>              
            </ul>

            <h3 class="text-blue-site overpassbold mt-5">MIEMBROS SUPLENTES</h3>
            <ul class="list-unstyled">
            ...
            <h3 class="text-blue-site overpassbold mt-5">JUNTA FISCALIZADORA - Miembros Titulares</h3>
            <ul class="list-unstyled">
                Miembros Titulares:
            ...
            <h3 class="text-blue-site overpassbold mt-5">JUNTA FISCALIZADORA - Miembros Suplentes</h3>
            <ul class="list-unstyled">
