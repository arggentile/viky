...
?>
    ...
    <div class="row row-turismo">
        ...
        <div class="col-lg-6 scroll-column">
            <h3 class="text-blue-site text-overpassbold"> El Condor </h3>
    ...
    <div class="row row-turismo">
        ...
        <!-- Columna con desplazamiento -->
        <div class="col-lg-6 scroll-column">
            <h3 class="text-blue-site text-overpassbold"> Nuestro Camping: </h3>
    ...
    <div class="row row-turismo" >
        <!-- Columna con desplazamiento -->
        <div class="col-lg-6 scroll-column">
            <h3 class="text-blue-site text-overpassbold"> Nuestro Complejo: </h3>
...
<div class="row row-turismo">
        <div class="col-lg-6 carousel-column">
            <div id="carouselExampleIndicators4" class="carouselExampleIndicators carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
