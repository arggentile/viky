...
<div class="">
    <div class="row">
        ...
        <div class="col-lg-6 scroll-column">
            <h3 class="text-blue-site text-overpassbalck text-uppercase"> DESCUENTOS EN FARMACIA </h3>
            ...
            <h6 class="text-blue-site text-overpassbold text-uppercase"> Horario de atención: </h6> 
            <p>
